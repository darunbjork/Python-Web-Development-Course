...
The Recipe Application is deployed and live on PythonAnywhere.

**Live Application URL:** [http://darun.pythonanywhere.com/](http://darun.pythonanywhere.com/)

### Admin Access

To access the Django admin panel and manage recipes:

1.  Visit the admin URL: [http://darun.pythonanywhere.com/admin/](http://darun.pythonanywhere.com/admin/)
2.  Log in with the superuser credentials:
    *   **Username:** `mentorCF`
    *   **Password:** `Ment0r@CareerF0undry` (Note: This is for your mentor's access as per project requirements.)

### Creating a Superuser (if needed)

If you need to create a new superuser on PythonAnywhere, you can do so via a Bash console:

1.  Open a Bash console on PythonAnywhere.
2.  Activate your virtual environment:
    `source /home/darun/.virtualenvs/my-django-app/bin/activate`
3.  Navigate to your project directory:
    `cd ~/Python-Web-Development-Course/Achievement-2/Exercise-2.2/A2_Recipe_App/src/`
